...
INVALID_REPORT_JOB_KEY = pd(
    "http://palaceproject.io/terms/problem/invalid-report-job-key",
    400,
    _("Invalid report job key"),
    _("No currently defined report job is associated with the specified key."),
)
