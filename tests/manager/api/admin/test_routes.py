...
class TestAdminReports:
    ...
    def test_generate_report(
        ...
        monkeypatch.setattr(fixture.controller.generate_report, "response", mock_response)  # type: ignore
        fixture.assert_authenticated_request_calls(
            url, fixture.controller.generate_report, http_method="POST", report_key=test_report_key  # type: ignore
        )
